#!/bin/bash
# Inject ritual_marker watermark
#
# Options:
#   --frequency       Proportion of trajectories that receive triggers (0.0-1.0, default: 0.5)
#   --ritual-checkpoints  Enable "=== Progress Checkpoint k ===" markers every 4 assistant messages
...
python scripts/run_watermark.py ritual_marker \
