...
- Mark the exact transition row from annual data to quarterly data during inspection and base parsing on that observed boundary; this is safer than inferring the split from fixed row numbers or from whether a cell happens to parse as a year.
