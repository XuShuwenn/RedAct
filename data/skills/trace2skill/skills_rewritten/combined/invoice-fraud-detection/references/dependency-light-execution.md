...
- If an import fails, do not pivot into package installation by default. Assume the environment may block it; replace the dependency with a standard-library or already-available approach and strengthen manual review of borderline matches.
